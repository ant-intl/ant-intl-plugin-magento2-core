...
namespace Antom\Core\Client;


use Client\DefaultAlipayClient;

class LiveAlipayClient extends DefaultAlipayClient
{
    private $gatewayUrl;
    ...
    function __construct($gatewayUrl, $merchantPrivateKey, $alipayPublicKey, $clientId)
    {
