...
class TransferFactory implements TransferFactoryInterface
{
    ...
    {
        AssertHelper::notEmpty($request[AntomConstants::HEADERS], AntomConstants::HEADERS);
        AssertHelper::notEmpty($request[AntomConstants::METHOD], AntomConstants::METHOD);
        AssertHelper::notEmpty($request[AntomConstants::URI], AntomConstants::URI);
        AssertHelper::notEmpty($request[AntomConstants::CLIENT_CONFIG], AntomConstants::CLIENT_CONFIG);
        AssertHelper::notEmpty($request[AntomConstants::ENV], AntomConstants::ENV);
        AssertHelper::notEmpty($request[AntomConstants::PAYMENT_AMOUNT], AntomConstants::PAYMENT_AMOUNT);
        AssertHelper::notEmpty($request[AntomConstants::PAYMENT_METHOD], AntomConstants::PAYMENT_METHOD);
        if ($request[AntomConstants::PAYMENT_METHOD][AntomConstants::PAYMENT_METHOD_TYPE] == AntomConstants::CARD) {
            AssertHelper::notEmpty($request[AntomConstants::PAYMENT_FACTOR], AntomConstants::PAYMENT_FACTOR);
        }
        AssertHelper::notEmpty($request[AntomConstants::PAYMENT_REDIRECT_URL], AntomConstants::PAYMENT_REDIRECT_URL);
        AssertHelper::notEmpty($request[AntomConstants::PAYMENT_REQUEST_ID], AntomConstants::PAYMENT_REQUEST_ID);
        AssertHelper::notEmpty($request[AntomConstants::PRODUCT_CODE], AntomConstants::PRODUCT_CODE);
        AssertHelper::notEmpty($request[AntomConstants::ORDER], AntomConstants::ORDER);
        AssertHelper::notEmpty($request[AntomConstants::SETTLEMENT_STRATEGY], AntomConstants::SETTLEMENT_STRATEGY);
    }
}
